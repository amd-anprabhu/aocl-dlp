...
GetError()
{
    return Xbyak::local::GetErrorRef();
}
...
inline const char*
ConvertErrorToString(const Error& err)
{
    return err.what();
}
...
class MmapAllocator : public Allocator
{
  ...
  public:
    explicit MmapAllocator(const std::string& name = "xbyak")
        : name_(name)
    {
    }
            ...
            static const char* tbl[4][32] = {
                {
                    ...
                    "bh",   "r8b",  "r9b",  "r10b", "r11b", "r12b", "r13b",
                    "r14b", "r15b", "r16b", "r17b", "r18b", "r19b", "r20b",
                    "r21b", "r22b", "r23b", "r24b", "r25b", "r26b", "r27b",
                    "r28b", "r29b", "r30b", "r31b",
                },
                {
                    "ax",   "cx",   "dx",   "bx",   "sp",   "bp",   "si",
                    "di",   "r8w",  "r9w",  "r10w", "r11w", "r12w", "r13w",
                    "r14w", "r15w", "r16w", "r17w", "r18w", "r19w", "r20w",
                    "r21w", "r22w", "r23w", "r24w", "r25w", "r26w", "r27w",
                    "r28w", "r29w", "r30w", "r31w",
                },
                {
                    "eax",  "ecx",  "edx",  "ebx",  "esp",  "ebp",  "esi",
                    "edi",  "r8d",  "r9d",  "r10d", "r11d", "r12d", "r13d",
                    "r14d", "r15d", "r16d", "r17d", "r18d", "r19d", "r20d",
                    "r21d", "r22d", "r23d", "r24d", "r25d", "r26d", "r27d",
                    "r28d", "r29d", "r30d", "r31d",
                },
                {
...
class Reg : public Operand
{
  public:
    ...
    Reg64 cvt64() const;
#endif
    Reg operator|(const ApxFlagNF&) const
    {
        Reg r(*this);
        r.setNF();
        return r;
    }
    Reg operator|(const ApxFlagZU&) const
    {
        Reg r(*this);
        r.setZU();
        return r;
...
{
    explicit XBYAK_CONSTEXPR Reg16(int idx = 0)
...
{
    explicit XBYAK_CONSTEXPR Mmx(int  idx  = 0,
                                 Kind kind = Operand::MMX,
                                 int  bit  = 64)
        : Reg(idx, kind, bit)
    {
    }
...
{
    explicit XBYAK_CONSTEXPR Xmm(int  idx  = 0,
                                 Kind kind = Operand::XMM,
                                 int  bit  = 128)
        : Mmx(idx, kind, bit)
    {
    }
...
{
    explicit XBYAK_CONSTEXPR Ymm(int  idx  = 0,
                                 Kind kind = Operand::YMM,
                                 int  bit  = 256)
        : Xmm(idx, kind, bit)
    {
    }
...
{
    explicit XBYAK_CONSTEXPR Zmm(int idx = 0)
...
{
    explicit XBYAK_CONSTEXPR Tmm(int  idx  = 0,
                                 Kind kind = Operand::TMM,
                                 int  bit  = 8192)
        : Reg(idx, kind, bit)
    {
    }
...
template<class T>
T
operator|(const T& x, const Opmask& k)
{
    T r(x);
...
template<class T>
T
operator|(const T& x, const EvexModifierZero&)
{
    T r(x);
    r.setZero();
    return r;
...
template<class T>
T
operator|(const T& x, const EvexModifierRounding& emr)
{
    T r(x);
    r.setRounding(emr.rounding);
    return r;
...
{
    explicit XBYAK_CONSTEXPR Fpu(int idx = 0)
...
struct Reg32e : public Reg
{
    ...
    Reg32e operator|(const ApxFlagNF&) const
    {
        Reg32e r(*this);
        r.setNF();
        return r;
    }
    Reg32e operator|(const ApxFlagZU&) const
    {
        Reg32e r(*this);
        r.setZU();
        return r;
...
{
    explicit XBYAK_CONSTEXPR Reg32(int idx = 0)
        : Reg32e(idx, 32)
    {
    }
};
...
{
    explicit XBYAK_CONSTEXPR Reg64(int idx = 0)
        : Reg32e(idx, 64)
    {
    }
};
struct RegRip
{
    ...
    const Label*             label_;
    bool                     isAddr_;
    explicit XBYAK_CONSTEXPR RegRip(int64_t      disp   = 0,
                                    const Label* label  = 0,
                                    bool         isAddr = false)
        : disp_(disp)
        , label_(label)
...
class Segment
{
  ...
  public:
    ...
    explicit XBYAK_CONSTEXPR Segment(int idx)
        : idx_(idx)
    {
...
#endif
    XBYAK_CONSTEXPR RegExp(size_t disp = 0)
        : scale_(0)
        , disp_(disp)
    {
    }
...
inline RegExp
operator+(const RegExp& a, const RegExp& b)
{
...
inline RegExp
operator*(const Reg& r, int scale)
{
    return RegExp(r, scale);
}
inline RegExp
operator*(int scale, const Reg& r)
{
    return r * scale;
}
inline RegExp
operator-(const RegExp& e, size_t disp)
{
    RegExp ret = e;
    ret.disp_ -= disp;
    return ret;
...
class CodeArray
{
  ...
  public:
    ...
    explicit CodeArray(size_t     maxSize,
                       void*      userPtr   = 0,
        ...
        , maxSize_(maxSize)
        , top_(type_ == USER_BUF
                   ? reinterpret_cast<uint8_t*>(userPtr)
...
class Address : public Operand
{
  public:
    ...
    XBYAK_CONSTEXPR Address(uint32_t      sizeBit,
                            bool          broadcast,
                            const RegRip& addr)
        : Operand(0, MEM, sizeBit)
        , e_(addr.disp_)
...
#endif
    RegExp  getRegExp() const { return optimize_ ? e_.optimize() : e_; }
    ...
    bool         operator==(const Address& rhs) const
    {
        return getBit() == rhs.getBit() && e_ == rhs.e_ && label_ == rhs.label_
               && mode_ == rhs.mode_ && immSize == rhs.immSize
               && disp8N == rhs.disp8N && permitVsib == rhs.permitVsib
               && broadcast_ == rhs.broadcast_ && optimize_ == rhs.optimize_;
    }
...
Operand::getAddress() const
{
    assert(isMEM());
    return static_cast<const Address&>(*this);
}
inline Address
Operand::getAddress(int immSize) const
{
...
inline XBYAK_CONSTEXPR bool
Operand::hasRex2() const
{
    return (isREG() && isExtIdx2())
           || (isMEM() && static_cast<const Address&>(*this).hasRex2());
}
...
class AddressFrame
{
  ...
  public:
    ...
    {
        return Address(bit_, broadcast_,
                       RegExp(reinterpret_cast<size_t>(disp)));
    }
#ifdef XBYAK64
...
struct JmpLabel
{
    ...
    explicit JmpLabel(size_t           endOfJmp = 0,
                      int              jmpSize  = 0,
                      inner::LabelMode mode     = inner::LasIs,
                      size_t           disp     = 0)
        : endOfJmp(endOfJmp)
        , jmpSize(jmpSize)
        , mode(mode)
...
class LabelManager
{
    ...
    void define_inner(DefList&   defList,
                      UndefList& undefList,
                      const T&   labelId,
                      size_t     addrOffset)
    {
    ...
    bool getOffset_inner(const DefList& defList,
                         size_t*        offset,
                         const T&       label) const
    {
    ...
    {
#ifndef NDEBUG
        for (typename T::const_iterator i = list.begin(); i != list.end();
             ++i) {
  ...
  public:
    ...
    void defineSlabel(std::string label)
    {
        ...
        SlabelState& st = *label.c_str() == '.' ? stateList_.back()
                                                : stateList_.front();
    ...
    void assign(Label& dst, const Label& src)
    {
        ...
        define_inner(clabelDefList_, clabelUndefList_, dst.id,
                     i->second.offset);
        dst.mgr = this;
    ...
    bool getOffset(size_t* offset, std::string& label) const
    {
        ...
        const SlabelState& st = *label.c_str() == '.' ? stateList_.back()
                                                      : stateList_.front();
...
class CodeGenerator : public CodeArray
{
  ...
  private:
                                          ...
                                          const Operand& op2)
    {
        return op1.isREG(i32e)
               && ((op2.isREG(i32e) && op1.getBit() == op2.getBit())
                   || op2.isMEM());
    }
    ...
    static inline uint8_t rexRXB(
        int bit, int bit3, const Reg& r, const Reg& b, const Reg& x = Reg())
    {
        int v = bit3 ? 8 : 0;
        if (r.hasIdxBit(bit))
            v |= 4;
    ...
    void rex2(
        int bit3, int rex4bit, const Reg& r, const Reg& b, const Reg& x = Reg())
    {
        db(0xD5);
        db((rexRXB(4, bit3, r, b, x) << 4) | rex4bit);
    }
    // return true if rex2 is selected
    bool rex(const Operand& op1,
             const Operand& op2  = Operand(),
             uint64_t       type = 0)
    {
        if (op1.getNF() | op2.getNF())
            XBYAK_THROW_RET(ERR_INVALID_NF, false)
        if (op1.getZU() | op2.getZU())
            XBYAK_THROW_RET(ERR_INVALID_ZU, false)
        uint8_t        rex = 0;
        const Operand *p1 = &op1, *p2 = &op2;
        if (p1->isMEM())
            std::swap(p1, p2);
        if (p1->isMEM())
            XBYAK_THROW_RET(ERR_BAD_COMBINATION, false)
        // except movsx(16bit, 32/64bit)
        bool p66 = (op1.isBit(16) && !op2.isBit(i32e))
        ...
        if (p2->isMEM()) {
            ...
            if (r.hasRex2() || addr.hasRex2()) {
                if (type & (T_0F38 | T_0F3A))
                    XBYAK_THROW_RET(ERR_CANT_USE_REX2, false)
            ...
            if (r1.hasRex2() || r2.hasRex2()) {
                if (type & (T_0F38 | T_0F3A))
                    XBYAK_THROW_RET(ERR_CANT_USE_REX2, 0)
                rex2(is0F, rex, r2, r1);
                return true;
            }
    ...
    static inline uint32_t getPP(uint64_t type)
    {
             ...
             bool           Hi16Vidx = false)
    {
        ...
        db(0x62);
        db((R ? 0 : 0x80) | (X3 ? 0 : 0x40) | (B ? 0 : 0x20) | (Rp ? 0 : 0x10)
           | (B4 ? 8 : 0) | mmm);
        db((w == 1 ? 0x80 : 0) | ((vvvv & 15) << 3) | (X4 ? 0 : 4) | (pp & 3));
        db((z ? 0x80 : 0) | ((LL & 3) << 5) | (b ? 0x10 : 0) | (V4 ? 0 : 8)
           | (aaa & 7));
        db(code);
        return disp8N;
    }
    // evex of Legacy
    void evexLeg(const Reg& r,
                 const Reg& b,
                 const Reg& x,
                 const Reg& v,
                 uint64_t   type,
                 int        sc = NONE)
    {
        ...
        int w  = (type & T_W0) ? 0
                               : (r.isBit(64) || v.isBit(64) || (type & T_W1));
        int V  = (~v.getIdx() & 15) << 3;
        int X4 = x.isExtIdx2() ? 0 : 0x04;
        int pp = (type & (T_F2 | T_F3 | T_66)) ? getPP(type)
                                               : (r.isBit(16) || v.isBit(16));
        int V4 = !v.isExtIdx2();
        int ND = (type & T_ZU)    ? (r.getZU() || b.getZU())
                 : (type & T_ND1) ? 1
                 : (type & T_APX) ? 0
                                  : v.isREG();
        ...
        int L  = 0;
        if ((type & T_NF) == 0 && NF)
            XBYAK_THROW(ERR_INVALID_NF)
        if ((type & T_ZU) == 0 && r.getZU())
            XBYAK_THROW(ERR_INVALID_ZU)
        db(0x62);
    ...
    void setSIB(const RegExp& e, int reg, int disp8N = 0)
    {
        ...
        if (!baseBit || ((baseIdx & 7) != Operand::EBP && disp == 0)) {
            ...
            if (disp8N == 0) {
                ...
                uint32_t t =
                    static_cast<uint32_t>(static_cast<int>(disp) / disp8N);
               ...
               uint8_t   longPref)
    {
        ...
        if (labelMgr_.getOffset(&offset, label)) { /* label exists */
            makeJmp(inner::VerifyInInt32(offset - size_), type, shortCode,
                    longCode, longPref);
        } else {
            int jmpSize = 0;
            if (isNEAR(type)) {
    ...
    void opAddr(const Address& addr, int reg)
    {
        ...
        if (addr.getMode() == Address::M_ModRM) {
            ...
            if (addr.getLabel()) { // [rip + Label]
                putL_inner(*addr.getLabel(), true,
                           addr.getDisp() - addr.immSize);
            } else {
    ...
    void opMovXMM(const Operand& op1,
                  const Operand& op2,
                  uint64_t       type,
                  int            code)
    {
               ...
               int            sc      = NONE)
    {
        ...
        if (p2->isMEM()) {
            ...
            evexLeg(static_cast<const Reg&>(op2), static_cast<const Reg&>(op1),
                    Reg(), d, type, sc);
            writeCode(type, d, code);
                ...
                const Reg*     d          = 0)
    {
        ...
        if ((type & T_APX) && op.hasRex2NFZU()
            && opROO(d ? *d : Reg(0, Operand::REG, opBit), op, r, type, code))
            return;
        if (op.isMEM()) {
    ...
    void opShift(const Operand& op, int imm, int ext, const Reg* d = 0)
    {
        ...
        if (d)
            type |= T_ND1;
        opRext(op, 0, ext & 7, type, (0xC0 | ((imm == 1 ? 1 : 0) << 4)), false,
               (imm != 1) ? 1 : 0, d);
        if (imm != 1)
            db(imm);
    }
    ...
    void opRO_MR(const Operand& op1, const Operand& op2, int code)
    {
        if (op2.isMEM()) {
            ...
            opRO(static_cast<const Reg&>(op2), op1, 0, code,
                 op1.getKind() == op2.getKind());
        }
    }
    uint32_t getImmBit(const Operand& op, uint32_t imm)
    {
        ...
        if (op.isBit(8))
            immBit = 8;
        if (op.getBit() < immBit)
            XBYAK_THROW_RET(ERR_IMM_IS_TOO_BIG, 0)
    ...
    // (r, r/m, imm)
    void opROI(
        const Reg& d, const Operand& op, uint32_t imm, uint64_t type, int ext)
    {
        uint32_t immBit = getImmBit(d, imm);
        int      code   = immBit < (std::min)(d.getBit(), 32U) ? 2 : 0;
        opROO(d, op, Reg(ext, Operand::REG, d.getBit()), type, 0x80 | code,
              immBit / 8);
        db(imm, immBit / 8);
    }
    ...
    */
    ...
    void putL_inner(T& label, bool relative = false, size_t disp = 0)
    {
        ...
        if (labelMgr_.getOffset(&offset, label)) {
            if (relative) {
                db(inner::VerifyInInt32(offset + disp - size_ - jmpSize),
                   jmpSize);
            } else if (isAutoGrow()) {
    ...
    void opFpuMem(const Address& addr,
                  uint8_t        m16,
                  uint8_t        m32,
                  uint8_t        m64,
                  uint8_t        ext,
    ...
    void opFpuFpu(const Fpu& reg1,
                  const Fpu& reg2,
                  uint32_t   code1,
                  uint32_t   code2)
    {
        uint32_t code = reg1.getIdx() == 0   ? code1
                        : reg2.getIdx() == 0 ? code2
                                             : 0;
        if (!code)
               ...
               int            imm8 = NONE)
    {
        if (op2.isMEM()) {
            ...
            if ((type & (T_MUST_EVEX | T_MEM_EVEX)) || r.hasEvex()
                || (p1 && p1->hasEvex()) || addr.isBroadcast()
                || addr.getOpmaskIdx() || addr.hasRex2()) {
                ...
                disp8N = evex(r, base, p1, type, code, &index, b, aaa, VL,
                              index.isSIMD() && index.isExtIdx2());
            } else {
    ...
    void opAVX_X_X_XM(const Xmm&     x1,
                      const Operand& op1,
                      const Operand& op2,
                      uint64_t       type,
                      int            code,
    ...
    void opAVX_K_X_XM(const Opmask&  k,
                      const Xmm&     x2,
                      const Operand& op3,
                      uint64_t       type,
                      int            code,
    ...
    void opAVX_X_XM_IMM(const Xmm&     x,
                        const Operand& op,
                        uint64_t       type,
                        int            code,
                        int            imm8 = NONE)
    ...
    void opCnt(const Reg& reg, const Operand& op, uint8_t code)
    {
        ...
        if (is16bit)
            db(0x66);
        opRO(reg.changeBit(i32e == 32 ? 32 : reg.getBit()), op, T_F3 | T_0F,
             code);
    }
    void opGather(const Xmm&     x1,
                  const Address& addr,
                  const Xmm&     x2,
                  uint64_t       type,
                  uint8_t        code,
                  int            mode)
    {
        ...
        opAVX_X_X_XM(isAddrYMM ? Ymm(i1) : x1, isAddrYMM ? Ymm(i3) : x2, addr,
                     type, code);
    }
    enum
    {
    ...
    */
    void opVmov(
        const Operand& op, const Xmm& x, uint64_t type, uint8_t code, bool mode)
    {
        if (mode) {
            if (!op.isMEM()
    ...
    void opGatherFetch(const Address& addr,
                       const Xmm&     x,
                       uint64_t       type,
                       uint8_t        code,
                       Operand::Kind  kind)
    ...
    void opCcmp(const Operand& op1,
                const Operand& op2,
                int            dfv,
                int            code,
                int            sc) // cmp = 0x38, test = 0x84
    {
        if (dfv < 0 || 15 < dfv)
            XBYAK_THROW(ERR_INVALID_DFV)
        opROO(Reg(15 - dfv, Operand::REG, (op1.getBit() | op2.getBit())), op1,
              op2, T_APX | T_CODE1_IF1, code, 0, sc);
    }
    void opCcmpi(const Operand& op, int imm, int dfv, int sc)
    {
        ...
        opROO(Reg(15 - dfv, Operand::REG, opBit), op,
              Reg(15, Operand::REG, opBit), T_APX | T_CODE1_IF1, 0x80 | tmp,
              immBit / 8, sc);
        db(imm, immBit / 8);
    }
    void opTesti(const Operand& op, int imm, int dfv, int sc)
    {
        ...
        opROO(Reg(15 - dfv, Operand::REG, opBit), op,
              Reg(0, Operand::REG, opBit), T_APX | T_CODE1_IF1, 0xF6,
              immBit / 8, sc);
        db(imm, immBit / 8);
    }
    void opCfcmov(const Reg&     d,
                  const Operand& op1,
                  const Operand& op2,
                  int            code)
    {
        ...
        if (op2.isMEM()) {
            ...
            opROO(d, op1, static_cast<const Reg&>(op2) | T_nf,
                  T_MUST_EVEX | T_NF, code);
        }
    }
#ifdef XBYAK64
    ...
    void opEncodeKey(const Reg32& r1,
                     const Reg32& r2,
                     uint8_t      code1,
                     uint8_t      code2)
    {
  ...
  public:
    ...
    const Reg64 rax, rcx, rdx, rbx, rsp, rbp, rsi, rdi, r8, r9, r10, r11, r12,
        r13, r14, r15;
    const Reg64 r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28,
        r29, r30, r31;
    const Reg32 r8d, r9d, r10d, r11d, r12d, r13d, r14d, r15d;
    const Reg32 r16d, r17d, r18d, r19d, r20d, r21d, r22d, r23d, r24d, r25d,
        r26d, r27d, r28d, r29d, r30d, r31d;
    const Reg16 r8w, r9w, r10w, r11w, r12w, r13w, r14w, r15w;
    const Reg16 r16w, r17w, r18w, r19w, r20w, r21w, r22w, r23w, r24w, r25w,
        r26w, r27w, r28w, r29w, r30w, r31w;
    const Reg8 r8b, r9b, r10b, r11b, r12b, r13b, r14b, r15b;
    const Reg8 r16b, r17b, r18b, r19b, r20b, r21b, r22b, r23b, r24b, r25b, r26b,
        r27b, r28b, r29b, r30b, r31b;
  ...
  public:
    ...
    */
    ...
    void mov(const Operand& op1, const Operand& op2)
    {
        ...
        uint8_t        code = 0;
        if (op1.isREG() && op1.getIdx() == 0
            && op2.isMEM()) { // mov eax|ax|al, [disp]
            reg  = &op1.getReg();
            addr = &op2.getAddress();
            code = 0xA0;
        } else if (op1.isMEM() && op2.isREG()
                   && op2.getIdx() == 0) { // mov [disp], eax|ax|al
            reg  = &op2.getReg();
            addr = &op1.getAddress();
            code = 0xA2;
        }
    ...
    void mov(const Operand& op, uint64_t imm)
    {
        if (op.isREG()) {
            ...
            opMR(op.getAddress(immSize), Reg(0, Operand::REG, op.getBit()), 0,
                 0xC6);
    ...
    void xchg(const Operand& op1, const Operand& op2)
    {
        ...
        opRO(static_cast<const Reg&>(*p1), *p2, 0,
             0x86 | (p1->isBit(8) ? 0 : 1),
             (p1->isREG() && (p1->getBit() == p2->getBit())));
    }
...
template<>
inline void
CodeGenerator::mov(const NativeReg& reg,
...
namespace util {
    static const XBYAK_CONSTEXPR Mmx mm0(0), mm1(1), mm2(2), mm3(3), mm4(4),
        mm5(5), mm6(6), mm7(7);
    static const XBYAK_CONSTEXPR Xmm xmm0(0), xmm1(1), xmm2(2), xmm3(3),
        xmm4(4), xmm5(5), xmm6(6), xmm7(7);
    static const XBYAK_CONSTEXPR Ymm ymm0(0), ymm1(1), ymm2(2), ymm3(3),
        ymm4(4), ymm5(5), ymm6(6), ymm7(7);
    static const XBYAK_CONSTEXPR Zmm zmm0(0), zmm1(1), zmm2(2), zmm3(3),
        zmm4(4), zmm5(5), zmm6(6), zmm7(7);
    static const XBYAK_CONSTEXPR Reg32 eax(Operand::EAX), ecx(Operand::ECX),
        edx(Operand::EDX), ebx(Operand::EBX), esp(Operand::ESP),
        ebp(Operand::EBP), esi(Operand::ESI), edi(Operand::EDI);
    ...
    static const XBYAK_CONSTEXPR AddressFrame ptr(0), byte(8), word(16),
        dword(32), qword(64), xword(128), yword(256), zword(512);
    static const XBYAK_CONSTEXPR AddressFrame ptr_b(0, true),
        xword_b(128, true), yword_b(256, true), zword_b(512, true);
    static const XBYAK_CONSTEXPR Fpu st0(0), st1(1), st2(2), st3(3), st4(4),
        st5(5), st6(6), st7(7);
    static const XBYAK_CONSTEXPR Opmask k0(0), k1(1), k2(2), k3(3), k4(4),
        k5(5), k6(6), k7(7);
    static const XBYAK_CONSTEXPR BoundsReg bnd0(0), bnd1(1), bnd2(2), bnd3(3);
    static const XBYAK_CONSTEXPR EvexModifierRounding
        T_sae(EvexModifierRounding::T_SAE),
        T_rn_sae(EvexModifierRounding::T_RN_SAE),
        T_rd_sae(EvexModifierRounding::T_RD_SAE),
        T_ru_sae(EvexModifierRounding::T_RU_SAE),
    ...
    static const XBYAK_CONSTEXPR Reg64 rax(Operand::RAX), rcx(Operand::RCX),
        rdx(Operand::RDX), rbx(Operand::RBX), rsp(Operand::RSP),
        rbp(Operand::RBP), rsi(Operand::RSI), rdi(Operand::RDI),
        r8(Operand::R8), r9(Operand::R9), r10(Operand::R10), r11(Operand::R11),
        r12(Operand::R12), r13(Operand::R13), r14(Operand::R14),
        r15(Operand::R15);
    static const XBYAK_CONSTEXPR Reg64 r16(16), r17(17), r18(18), r19(19),
        r20(20), r21(21), r22(22), r23(23), r24(24), r25(25), r26(26), r27(27),
        r28(28), r29(29), r30(30), r31(31);
    static const XBYAK_CONSTEXPR Reg32 r8d(8), r9d(9), r10d(10), r11d(11),
        r12d(12), r13d(13), r14d(14), r15d(15);
    static const XBYAK_CONSTEXPR Reg32 r16d(16), r17d(17), r18d(18), r19d(19),
        r20d(20), r21d(21), r22d(22), r23d(23), r24d(24), r25d(25), r26d(26),
        r27d(27), r28d(28), r29d(29), r30d(30), r31d(31);
    static const XBYAK_CONSTEXPR Reg16 r8w(8), r9w(9), r10w(10), r11w(11),
        r12w(12), r13w(13), r14w(14), r15w(15);
    static const XBYAK_CONSTEXPR Reg16 r16w(16), r17w(17), r18w(18), r19w(19),
        r20w(20), r21w(21), r22w(22), r23w(23), r24w(24), r25w(25), r26w(26),
        r27w(27), r28w(28), r29w(29), r30w(30), r31w(31);
    static const XBYAK_CONSTEXPR Reg8 r8b(8), r9b(9), r10b(10), r11b(11),
        r12b(12), r13b(13), r14b(14), r15b(15), spl(Operand::SPL, true),
        bpl(Operand::BPL, true), sil(Operand::SIL, true),
        dil(Operand::DIL, true);
    static const XBYAK_CONSTEXPR Reg8 r16b(16), r17b(17), r18b(18), r19b(19),
        r20b(20), r21b(21), r22b(22), r23b(23), r24b(24), r25b(25), r26b(26),
        r27b(27), r28b(28), r29b(29), r30b(30), r31b(31);
    ...
    static const XBYAK_CONSTEXPR Zmm tmm0(0), tmm1(1), tmm2(2), tmm3(3),
